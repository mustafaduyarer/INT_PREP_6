...
public class ApiUtilities {
    ...
    // Kullanıcı istediği endpoint'e post tipinde ve dataları form params içerisinde göndererek bağlanabilecek
    ...
    // Kullanıcı istediği endpoint'e post tipinde ve dataları body bölümünde göndererek bağlanabilecek
